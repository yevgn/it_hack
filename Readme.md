...
## Замечания
К сожелению, мы не успели сделать front-часть, однако API можно использовать. Back-часть хранится в директории backend. Будем рады, если вы внимательно изучите код проекта.
