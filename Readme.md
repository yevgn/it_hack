# Проект: Расчет возрастания пассажиропотока

## Описание
Этот проект представляет собой сервис для оценки увеличения пассажиропотока на дорогах и станциях метро при застройке новой территории. Сервис позволяет моделировать и анализировать потенциальные изменения в транспортных потоках, что может быть полезно для городских планировщиков и инженеров.
